...
## [0.2.0](https://github.com/JustinClarke/off-the-pace/compare/v0.1.0...v0.2.0) (2026-09-25)
...
* Add int_lap_corner_inputs model for corner-level driver inputs ([bf2d9a6](https://github.com/JustinClarke/off-the-pace/commit/bf2d9a634bbbddf0bacf8bddeadf521e563a1595))
...
* implement 14 new singular dbt tests to enforce data integrity and validate model output logic across the transformation layer. ([c7c8509](https://github.com/JustinClarke/off-the-pace/commit/c7c850952a13d6670e2f4af103c9ee9bb852bcc8))
* Implement AFT survival model and associated metrics ([cdf2523](https://github.com/JustinClarke/off-the-pace/commit/cdf252349685d44e02de9ea11074d4735698d154))
...
* **_roadmap:** consolidate improvements and roadmap folder structure ([57c4039](https://github.com/JustinClarke/off-the-pace/commit/57c40393e49f89b5309513bd3fc135359e3aa658))
