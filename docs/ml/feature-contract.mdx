...
<Info>
  **Two target spans.** The quantile trio and cliff classifier train on **113,309 laps** that carry the degradation and cliff targets; the stint-life regressor trains on **119,876 laps** the spans differ because a lap can have a valid stint-life count even where its next-lap jump is undefined.
</Info>
