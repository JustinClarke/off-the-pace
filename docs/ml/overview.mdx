...
```mermaid
flowchart TD
    A["Physics decomposition<br/>(seven-term identity)"] --> B["fct_cliff_prediction_features<br/>33 features · 2018–2024"]
...
<CardGroup cols={2}>
  ...
  <Card title="The CI Contract" href="/ml/ci/overview" icon="vial">
    All 177 tests 21 leakage-spine guards, 5 ONNX parity, 3 predict-schema, 19 evaluation gates, 3 target/censoring, 18 survival/AFT, 18 version-contract, 19 attainable-ceiling, 33 within-stint attribution, 24 fit-parity, 14 search-space grouped and explained.
  </Card>
