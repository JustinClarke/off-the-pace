...
<Info>
  **One mart, two target spans.** The quantile trio and the cliff classifier train on **113,309 laps** that carry the degradation and cliff targets; the stint-life regressor trains on **119,876 laps** the spans differ because a lap can have a usable stint-life count even where its next-lap jump is undefined. All seven seasons (2018–2024) feed in, and the **19,067-lap 2024 fold** stands in as the evaluation holdout until 2025 ingests.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="The CI Contract" href="/ml/ci/overview" icon="vial">
    All 28 tests 12 leakage-spine guards, 5 ONNX parity, 3 predict-schema, 7 evaluation gates, 1 target bound grouped and explained.
  </Card>
