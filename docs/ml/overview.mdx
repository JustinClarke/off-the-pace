...
<CardGroup cols={2}>
  ...
  <Card title="The CI Contract" href="/ml/ci/overview" icon="vial">
    All 64 tests 14 leakage-spine guards, 5 ONNX parity, 3 predict-schema, 7 evaluation gates, 3 target/censoring, 18 survival/AFT, 14 version-contract grouped and explained.
  </Card>
