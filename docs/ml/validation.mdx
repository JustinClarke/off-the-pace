...
These five guards are part of the **28-test suite** (12 spine + 5 ONNX parity + 3 predict + 7 evaluate + 1 targets) and run automatically in CI on every change. Reproduce locally with `make ml-test`.
