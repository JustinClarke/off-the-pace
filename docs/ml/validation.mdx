...
- **The cliff classifier is the weakest model.** Macro-F1 ≈ 0.40 decisively beats the majority prior but is modest in absolute terms; skill on the rare imminent-cliff windows is limited. The 100 most-confident misses are exported for study and inform the v2 roadmap.
