...
The open-source Python library used to fetch historical F1 lap timing, telemetry, and weather data from the Ergast and F1 livetiming APIs. All Bronze-layer data originates from FastF1. Known limitations include missing race car/position streams for 2018 Rd1 and Rd2, and a `session_time_s` regression in v3.8.3 affecting 2024 race control data.
</Accordion>
