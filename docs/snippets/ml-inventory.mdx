<CardGroup cols={3}>
  ...
  <Card title="33 features in 6 groups" icon="layers">
  ...
  <Card title="177 tests" icon="shield-check">
    21 Leakage Spine + 5 ONNX Parity + 3 Predict Schema + 19 Evaluation Gates + 3 Targets + 18 Survival + 18 Version Contract + 19 Attainable Ceilings + 33 Within-stint Attribution + 24 Fit Parity + 14 Search Space every build.
  </Card>
  <Card title="82,315 training laps" icon="database">
