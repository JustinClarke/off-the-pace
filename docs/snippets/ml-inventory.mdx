<CardGroup cols={3}>
  ...
  <Card title="64 tests" icon="shield-check">
    14 Leakage Spine + 5 ONNX Parity + 3 Predict Schema + 7 Evaluation Gates + 3 Targets + 18 Survival + 14 Version Contract every build.
  </Card>
