...
| `dim_compounds_season` | Reference |   |   |   | 3 |   | 3 |
...
| `compound_cliff_params` | Reference (seed) | 4 |   |   | 4 |   | 8 |
| `race_scheduled_laps` | Reference (seed) | 1 |   |   | 1 |   | 2 |
| `tyre_allocations` | Reference (seed) |   |   |   | 3 |   | 3 |
| **Total** |  | 73 | 4 | 1 | 40 | 4 | **122** |
