...
| `stg_weather` | Staging | 1 |   |   | 1 |
| `dim_circuits` | Reference | 4 | 1 |   | 5 |
| `dim_compounds_season` | Reference | 8 |   |   | 8 |
...
| `int_lap_fuel_state` | Physics | 4 | 1 |   | 5 |
...
| `int_qualifying_driver_summary` | Pace Baselines | 4 |   | 1 | 5 |
...
| `int_pit_strategy_value` | Strategy | 5 | 1 |   | 6 |
...
| `compound_cliff_params` | Reference (seed) | 11 |   |   | 11 |
| `race_scheduled_laps` | Reference (seed) | 4 | 1 |   | 5 |
