...
| `stg_laps` | Staging | 5 | 1 |   | 6 |
| `stg_laps_qualifying` | Staging | 5 | 1 |   | 6 |
| `stg_pits` | Staging | 1 |   |   | 1 |
...
| `int_corner_metrics` | Physics | 4 |   |   | 4 |
| `int_dirty_air_tax_component` | Physics | 7 | 1 |   | 8 |
| `int_lap_air_state` | Physics | 1 | 1 |   | 2 |
...
| `int_stint_geometry` | Physics | 2 | 1 |   | 3 |
...
| `int_driver_circuit_affinity` | Skill | 11 | 1 |   | 12 |
...
| `int_lap_residual_decomposed_qualifying` | Residual | 2 | 1 |   | 3 |
| `int_lap_residual_stint_detrend` | Residual | 2 |   |   | 2 |
| `int_qualifying_decomposed` | Residual | 2 | 1 |   | 3 |
...
| `int_pit_loss_circuit` | Strategy | 4 | 1 |   | 5 |
| `int_pit_strategy_value` | Strategy | 1 | 1 |   | 2 |
| `int_sc_hazard_history` | Strategy | 9 | 1 |   | 10 |
| `dim_events` | Marts | 2 | 1 |   | 3 |
| `fct_ghost_car_pace` | Marts | 18 | 1 |   | 19 |
| `fct_ghost_race_finish` | Marts | 7 | 1 |   | 8 |
| `fct_lap_residuals` | Marts | 16 | 1 |   | 17 |
| `fct_stint_features` | Marts | 6 | 1 |   | 7 |
| `fct_telemetry_deltas` | Marts | 9 |   |   | 9 |
| `mart_corner_skill_driver` | Marts | 11 |   | 1 | 12 |
