<CardGroup cols={3}>
  <Card title="71 models" icon="database">
    Staging (16) + Reference (5) + 40
    intermediate models across 5 families + Marts (10).
  </Card>
  <Card title="594 tests" icon="shield-check">
    538 generic column contracts + 56 hand-written mathematical
    assertions, every build.
  </Card>
  <Card title="440 structural" icon="key">
    `not_null`, `unique`, and unique-combination tests guard every model's grain.
  </Card>
  <Card title="98 range &amp; domain" icon="ruler">
  ...
  <Card title="40 domain + 2 regression" icon="check-check">
