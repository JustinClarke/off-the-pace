...
Five Python generators that keep `docs/docs/reference/` in sync with the source code and
...
```
source files  →  scripts/build_reference.py  →  docs/docs/reference/**/*.mdx
                       │
...
| `gen_dbt_reference.py` | `docs/docs/reference/models/**` + `macros/**` | `transform/target/manifest.json` |
| `gen_schema_reference.py` | `docs/docs/reference/schemas/**` | `ingestion/schemas/*.json` |
| `gen_cli_reference.py` | `docs/docs/reference/cli/**` | Python `--help` output from `ingestion/src/` |
| `gen_macro_reference.py` | `docs/docs/reference/macros/**` | macro SQL + docstrings |
| `gen_ml_reference.py` | `docs/docs/reference/ml/degradation-model-v1.mdx` | `ml/model_card.yml` |
...
- **Downstream:** Docusaurus site (`docs/docs/reference/`), `docs-ci.yml`
