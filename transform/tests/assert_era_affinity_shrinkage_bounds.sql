-- int_driver_circuit_era_affinity identity: Bayesian shrinkage bounds
--
-- Bayesian shrinkage with a proper prior is convex: the posterior mean must lie
-- between (or equal to) the observed and prior means, within each era cell.
--
